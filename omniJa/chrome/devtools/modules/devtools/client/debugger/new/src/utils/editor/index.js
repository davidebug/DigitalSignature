...
function shouldShowPrettyPrint(source) {
  return (0, _source.shouldPrettyPrint)(source);
}

function shouldShowFooter(source, horizontal) {
  if (!horizontal) {
    return true;
  }
  if (!source) {
  ...
  return shouldShowPrettyPrint(source) || (0, _source.isOriginal)(source);
}
