...
class SecondaryPanes extends _react.Component {
  ...
  getScopesButtons() {
    ...
    if (!_prefs.features.mapScopes || !selectedFrame || (0, _devtoolsSourceMap.isGeneratedId)(selectedFrame.location.sourceId)) {
      return null;
    }
...
const mapStateToProps = state => {
  ...
  return {
    ...
    shouldMapScopes: (0, _selectors.getMapScopes)(state),
