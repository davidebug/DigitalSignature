...
class EditorMenu extends _react.Component {
  ...
  showMenu(props) {
    ...
    const location = (0, _editor.getSourceLocationFromMouseEvent)(editor, selectedSource,
...
const mapStateToProps = (state, props) => ({
  ...
  hasPrettySource: !!(0, _selectors.getPrettySource)(state, props.selectedSource.id)
});
