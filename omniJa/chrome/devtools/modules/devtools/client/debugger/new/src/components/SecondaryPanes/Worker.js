...
class Worker extends _react.Component {
  ...
  render() {
    ...
    const label = (0, _workers.isWorker)(thread) ? (0, _workers.getDisplayName)(thread) : L10N.getStr("mainThread");
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        "div",
        { clasName: "icon" },
        _react2.default.createElement(_AccessibleImage2.default, { className: _workers.isWorker ? "worker" : "file" })
      ),
      _react2.default.createElement(
        "div",
        { className: "label" },
