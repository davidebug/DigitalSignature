...
public class ArgsParser {
	...
	private static String className = "ArgsParser";
	...
	public void showHelp() {
		...
		MiddlewareChrome.log(className,"Usage:" + jCommander.getProgramDisplayName());
		MiddlewareChrome.log(className," Options:");
		for (ParameterDescription parameterDescription : parameters) {
			MiddlewareChrome.log(className," " + parameterDescription.getNames().toString());
			MiddlewareChrome.log(className,"\t" + parameterDescription.getDescription().toString());
		}
	}
	...
	public class FileConverter implements IStringConverter<File> {
		...
		public File convert(String value) {
			MiddlewareChrome.log(className,value);
